...
typedef void (*Ptr_gtk_rc_add_default_file)(const gchar*);
typedef void (*Ptr_gtk_rc_reparse_all_for_settings)(GtkSettings *,bool);
typedef void (*Ptr_gtk_rc_reparse_all)(void);
...
public:
    ...
    static Ptr_gtk_rc_add_default_file gtk_rc_add_default_file;
    static Ptr_gtk_rc_reparse_all_for_settings gtk_rc_reparse_all_for_settings;
    static Ptr_gtk_rc_reparse_all gtk_rc_reparse_all;
    static Ptr_gtk_rc_get_theme_dir gtk_rc_get_theme_dir;
