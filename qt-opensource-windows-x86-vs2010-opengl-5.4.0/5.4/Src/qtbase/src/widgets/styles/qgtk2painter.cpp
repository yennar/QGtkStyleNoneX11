...
void * resolveFunc(const char * str) {
...
static void initGtk()
{
    ...
    if (!initialized) {
        ...
        QGtk2PainterPrivate::gdk_pixmap_new = (Ptr_gdk_pixmap_new)resolveFunc("gdk_pixmap_new");
        QGtk2PainterPrivate::gdk_pixbuf_get_from_drawable = (Ptr_gdk_pixbuf_get_from_drawable)resolveFunc("gdk_pixbuf_get_from_drawable");
        QGtk2PainterPrivate::gdk_draw_rectangle = (Ptr_gdk_draw_rectangle)resolveFunc("gdk_draw_rectangle");
        QGtk2PainterPrivate::gdk_drawable_unref = (Ptr_gdk_drawable_unref)resolveFunc("gdk_drawable_unref");

        QGtk2PainterPrivate::gtk_paint_check = (Ptr_gtk_paint_check)resolveFunc("gtk_paint_check");
        QGtk2PainterPrivate::gtk_paint_box = (Ptr_gtk_paint_box)resolveFunc("gtk_paint_box");
        QGtk2PainterPrivate::gtk_paint_flat_box = (Ptr_gtk_paint_flat_box)resolveFunc("gtk_paint_flat_box");
        QGtk2PainterPrivate::gtk_paint_check = (Ptr_gtk_paint_check)resolveFunc("gtk_paint_check");
        QGtk2PainterPrivate::gtk_paint_box = (Ptr_gtk_paint_box)resolveFunc("gtk_paint_box");
        QGtk2PainterPrivate::gtk_paint_resize_grip = (Ptr_gtk_paint_resize_grip)resolveFunc("gtk_paint_resize_grip");
        QGtk2PainterPrivate::gtk_paint_focus = (Ptr_gtk_paint_focus)resolveFunc("gtk_paint_focus");
        QGtk2PainterPrivate::gtk_paint_shadow = (Ptr_gtk_paint_shadow)resolveFunc("gtk_paint_shadow");
        QGtk2PainterPrivate::gtk_paint_slider = (Ptr_gtk_paint_slider)resolveFunc("gtk_paint_slider");
        QGtk2PainterPrivate::gtk_paint_expander = (Ptr_gtk_paint_expander)resolveFunc("gtk_paint_expander");
        QGtk2PainterPrivate::gtk_paint_handle = (Ptr_gtk_paint_handle)resolveFunc("gtk_paint_handle");
        QGtk2PainterPrivate::gtk_paint_option = (Ptr_gtk_paint_option)resolveFunc("gtk_paint_option");
        QGtk2PainterPrivate::gtk_paint_arrow = (Ptr_gtk_paint_arrow)resolveFunc("gtk_paint_arrow");
        QGtk2PainterPrivate::gtk_paint_box_gap = (Ptr_gtk_paint_box_gap)resolveFunc("gtk_paint_box_gap");
        QGtk2PainterPrivate::gtk_paint_extension = (Ptr_gtk_paint_extension)resolveFunc("gtk_paint_extension");
        QGtk2PainterPrivate::gtk_paint_hline = (Ptr_gtk_paint_hline)resolveFunc("gtk_paint_hline");
        QGtk2PainterPrivate::gtk_paint_vline = (Ptr_gtk_paint_vline)resolveFunc("gtk_paint_vline");
