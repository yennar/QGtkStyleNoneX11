 ...
 */
void * QGtkStylePrivate::resolveFunc(const char * str) const {
    ...
    void * ptr;
    ptr = libgtk.resolve(str);
    if (ptr != NULL) return ptr;
    ptr = libgdk.resolve(str);
    if (ptr != NULL) return ptr;
    ptr = libgdkpb.resolve(str);
    if (ptr != NULL) return ptr;
    ptr = libpango.resolve(str);
    if (ptr != NULL) return ptr;
...
void QGtkStylePrivate::resolveGtk() const
{
    // enforce the "0" suffix, so we'll open libgtk-x11-2.0.so.0
        ...
        QLibrary libpango(QLS("libpango-1.0-0.dll"), 0, 0);
            ...
            QLibrary libgdk(QLS("gtk-quartz-2.0"), 0, 0);
            QLibrary libgdkpb(QLS("gtk-quartz-2.0"), 0, 0);
            QLibrary libpango(QLS("gtk-quartz-2.0"), 0, 0);        
        #else
            QLibrary libgtk(QLS("gtk-x11-2.0"), 0, 0);        
            QLibrary libgdk(QLS("gtk-x11-2.0"), 0, 0);
            QLibrary libgdkpb(QLS("gtk-x11-2.0"), 0, 0);
            QLibrary libpango(QLS("gtk-x11-2.0"), 0, 0);    
        #endif
    #endif    
    ...
    gtk_init = (Ptr_gtk_init)resolveFunc("gtk_init");
    g_gtk_init = gtk_init;
    gtk_window_new = (Ptr_gtk_window_new)resolveFunc("gtk_window_new");
    gtk_style_attach = (Ptr_gtk_style_attach)resolveFunc("gtk_style_attach");
    gtk_widget_destroy = (Ptr_gtk_widget_destroy)resolveFunc("gtk_widget_destroy");
    gtk_widget_realize = (Ptr_gtk_widget_realize)resolveFunc("gtk_widget_realize");

    gdk_pixbuf_get_pixels = (Ptr_gdk_pixbuf_get_pixels)resolveFunc("gdk_pixbuf_get_pixels");
    gdk_pixbuf_get_width = (Ptr_gdk_pixbuf_get_width)resolveFunc("gdk_pixbuf_get_width");
    gdk_pixbuf_get_height = (Ptr_gdk_pixbuf_get_height)resolveFunc("gdk_pixbuf_get_height");
    gdk_pixbuf_new = (Ptr_gdk_pixbuf_new)resolveFunc("gdk_pixbuf_new");
    gdk_pixbuf_unref = (Ptr_gdk_pixbuf_unref)resolveFunc("gdk_pixbuf_unref");
    gdk_color_free = (Ptr_gdk_color_free)resolveFunc("gdk_color_free");
    //gdk_x11_window_set_user_time = (Ptr_gdk_x11_window_set_user_time)resolveFunc("gdk_x11_window_set_user_time");
    //gdk_x11_drawable_get_xid = (Ptr_gdk_x11_drawable_get_xid)resolveFunc("gdk_x11_drawable_get_xid");
    //gdk_x11_drawable_get_xdisplay = (Ptr_gdk_x11_drawable_get_xdisplay)resolveFunc("gdk_x11_drawable_get_xdisplay");

    gtk_widget_set_default_direction = (Ptr_gtk_widget_set_default_direction)resolveFunc("gtk_widget_set_default_direction");
    gtk_widget_modify_fg = (Ptr_gtk_widget_modify_color)resolveFunc("gtk_widget_modify_fg");
    gtk_widget_modify_bg = (Ptr_gtk_widget_modify_color)resolveFunc("gtk_widget_modify_bg");
    gtk_arrow_new = (Ptr_gtk_arrow_new)resolveFunc("gtk_arrow_new");
    gtk_menu_item_new_with_label = (Ptr_gtk_menu_item_new_with_label)resolveFunc("gtk_menu_item_new_with_label");
    gtk_check_menu_item_new_with_label = (Ptr_gtk_check_menu_item_new_with_label)resolveFunc("gtk_check_menu_item_new_with_label");
    gtk_menu_bar_new = (Ptr_gtk_menu_bar_new)resolveFunc("gtk_menu_bar_new");
    gtk_menu_new = (Ptr_gtk_menu_new)resolveFunc("gtk_menu_new");
    gtk_toolbar_new = (Ptr_gtk_toolbar_new)resolveFunc("gtk_toolbar_new");
    gtk_separator_tool_item_new = (Ptr_gtk_separator_tool_item_new)resolveFunc("gtk_separator_tool_item_new");
    gtk_toolbar_insert = (Ptr_gtk_toolbar_insert)resolveFunc("gtk_toolbar_insert");
    gtk_button_new = (Ptr_gtk_button_new)resolveFunc("gtk_button_new");
    gtk_tool_button_new = (Ptr_gtk_tool_button_new)resolveFunc("gtk_tool_button_new");
    gtk_hbutton_box_new = (Ptr_gtk_hbutton_box_new)resolveFunc("gtk_hbutton_box_new");
    gtk_check_button_new = (Ptr_gtk_check_button_new)resolveFunc("gtk_check_button_new");
    gtk_radio_button_new = (Ptr_gtk_radio_button_new)resolveFunc("gtk_radio_button_new");
    gtk_notebook_new = (Ptr_gtk_notebook_new)resolveFunc("gtk_notebook_new");
    gtk_progress_bar_new = (Ptr_gtk_progress_bar_new)resolveFunc("gtk_progress_bar_new");
    gtk_spin_button_new = (Ptr_gtk_spin_button_new)resolveFunc("gtk_spin_button_new");
    gtk_hscale_new = (Ptr_gtk_hscale_new)resolveFunc("gtk_hscale_new");
    gtk_vscale_new = (Ptr_gtk_vscale_new)resolveFunc("gtk_vscale_new");
    gtk_hscrollbar_new = (Ptr_gtk_hscrollbar_new)resolveFunc("gtk_hscrollbar_new");
    gtk_vscrollbar_new = (Ptr_gtk_vscrollbar_new)resolveFunc("gtk_vscrollbar_new");
    gtk_scrolled_window_new = (Ptr_gtk_scrolled_window_new)resolveFunc("gtk_scrolled_window_new");
    gtk_menu_shell_append = (Ptr_gtk_menu_shell_append)resolveFunc("gtk_menu_shell_append");
    gtk_entry_new = (Ptr_gtk_entry_new)resolveFunc("gtk_entry_new");
    gtk_tree_view_new = (Ptr_gtk_tree_view_new)resolveFunc("gtk_tree_view_new");
    gtk_combo_box_new = (Ptr_gtk_combo_box_new)resolveFunc("gtk_combo_box_new");
    gtk_combo_box_entry_new = (Ptr_gtk_combo_box_entry_new)resolveFunc("gtk_combo_box_entry_new");
    gtk_range_get_adjustment = (Ptr_gtk_range_get_adjustment)resolveFunc("gtk_range_get_adjustment");
    gtk_range_set_adjustment = (Ptr_gtk_range_set_adjustment)resolveFunc("gtk_range_set_adjustment");
    gtk_range_set_inverted = (Ptr_gtk_range_set_inverted)resolveFunc("gtk_range_set_inverted");
    gtk_container_add = (Ptr_gtk_container_add)resolveFunc("gtk_container_add");
    gtk_icon_factory_lookup_default = (Ptr_gtk_icon_factory_lookup_default)resolveFunc("gtk_icon_factory_lookup_default");
    gtk_icon_theme_get_default = (Ptr_gtk_icon_theme_get_default)resolveFunc("gtk_icon_theme_get_default");
    gtk_widget_get_style = (Ptr_gtk_widget_get_style)resolveFunc("gtk_widget_get_style");
    gtk_widget_style_get = (Ptr_gtk_widget_style_get)resolveFunc("gtk_widget_style_get");
    gtk_icon_set_render_icon = (Ptr_gtk_icon_set_render_icon)resolveFunc("gtk_icon_set_render_icon");
    gtk_fixed_new = (Ptr_gtk_fixed_new)resolveFunc("gtk_fixed_new");
    gtk_tree_view_column_new = (Ptr_gtk_tree_view_column_new)resolveFunc("gtk_tree_view_column_new");
    gtk_tree_view_append_column= (Ptr_gtk_tree_view_append_column )resolveFunc("gtk_tree_view_append_column");
    gtk_tree_view_get_column = (Ptr_gtk_tree_view_get_column )resolveFunc("gtk_tree_view_get_column");
    gtk_adjustment_configure = (Ptr_gtk_adjustment_configure)resolveFunc("gtk_adjustment_configure");
    gtk_adjustment_new = (Ptr_gtk_adjustment_new)resolveFunc("gtk_adjustment_new");
    gtk_menu_item_set_submenu = (Ptr_gtk_menu_item_set_submenu)resolveFunc("gtk_menu_item_set_submenu");
    gtk_settings_get_default = (Ptr_gtk_settings_get_default)resolveFunc("gtk_settings_get_default");
    gtk_separator_menu_item_new = (Ptr_gtk_separator_menu_item_new)resolveFunc("gtk_separator_menu_item_new");
    gtk_frame_new = (Ptr_gtk_frame_new)resolveFunc("gtk_frame_new");
    gtk_expander_new = (Ptr_gtk_expander_new)resolveFunc("gtk_expander_new");
    gtk_statusbar_new = (Ptr_gtk_statusbar_new)resolveFunc("gtk_statusbar_new");
    gtk_container_forall = (Ptr_gtk_container_forall)resolveFunc("gtk_container_forall");
    gtk_widget_size_allocate =(Ptr_gtk_widget_size_allocate)resolveFunc("gtk_widget_size_allocate");
    gtk_widget_size_request =(Ptr_gtk_widget_size_request)resolveFunc("gtk_widget_size_request");
    gtk_widget_set_direction =(Ptr_gtk_widget_set_direction)resolveFunc("gtk_widget_set_direction");
    gtk_widget_path =(Ptr_gtk_widget_path)resolveFunc("gtk_widget_path");
    gtk_container_get_type =(Ptr_gtk_container_get_type)resolveFunc("gtk_container_get_type");
    gtk_window_get_type =(Ptr_gtk_window_get_type)resolveFunc("gtk_window_get_type");
    gtk_widget_get_type =(Ptr_gtk_widget_get_type)resolveFunc("gtk_widget_get_type");
    gtk_widget_get_parent =(Ptr_gtk_widget_get_parent)resolveFunc("gtk_widget_get_parent");
    gtk_widget_is_toplevel =(Ptr_gtk_widget_is_toplevel)resolveFunc("gtk_widget_is_toplevel");
    gtk_widget_get_toplevel =(Ptr_gtk_widget_get_toplevel)resolveFunc("gtk_widget_get_toplevel");

    gtk_rc_get_style_by_paths =(Ptr_gtk_rc_get_style_by_paths)resolveFunc("gtk_rc_get_style_by_paths");
    gtk_check_version =(Ptr_gtk_check_version)resolveFunc("gtk_check_version");
    gtk_border_free =(Ptr_gtk_border_free)resolveFunc("gtk_border_free");
    gtk_widget_get_allocation = (Ptr_gtk_widget_get_allocation)resolveFunc("gtk_widget_get_allocation");
    gtk_widget_set_allocation = (Ptr_gtk_widget_set_allocation)resolveFunc("gtk_widget_set_allocation");

    gtk_widget_set_can_default = (Ptr_gtk_widget_set_can_default)resolveFunc("gtk_widget_set_can_default");
    gtk_window_set_default = (Ptr_gtk_window_set_default)resolveFunc("gtk_window_set_default");

    gdk_event_new = (Ptr_gdk_event_new)resolveFunc("gdk_event_new");
    gdk_event_free = (Ptr_gdk_event_free)resolveFunc("gdk_event_free");
    gtk_widget_send_focus_change = (Ptr_gtk_widget_send_focus_change)resolveFunc("gtk_widget_send_focus_change");

    pango_font_description_get_size = (Ptr_pango_font_description_get_size)resolveFunc("pango_font_description_get_size");
    pango_font_description_get_weight = (Ptr_pango_font_description_get_weight)resolveFunc("pango_font_description_get_weight");
    pango_font_description_get_family = (Ptr_pango_font_description_get_family)resolveFunc("pango_font_description_get_family");
    pango_font_description_get_style = (Ptr_pango_font_description_get_style)resolveFunc("pango_font_description_get_style");
