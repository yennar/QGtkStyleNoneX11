...
Ptr_gtk_rc_add_default_file QGtkStylePrivate::gtk_rc_add_default_file = 0;
Ptr_gtk_rc_reparse_all_for_settings QGtkStylePrivate::gtk_rc_reparse_all_for_settings = 0;
Ptr_gtk_rc_reparse_all QGtkStylePrivate::gtk_rc_reparse_all = 0;
Ptr_gtk_rc_get_theme_dir QGtkStylePrivate::gtk_rc_get_theme_dir = 0;
 ...
 */
Ptr_gtk_init g_gtk_init;

void * libgtk_resolve (const char * func) {
    #ifdef Q_OS_WIN
        QLibrary libgtk(QLS("libgtk-win32-2.0-0.dll"), 0, 0);
        QLibrary libgdk(QLS("libgdk-win32-2.0-0.dll"), 0, 0);
        QLibrary libgdkpb(QLS("libgdk_pixbuf-2.0-0.dll"), 0, 0);
        QLibrary libpango(QLS("libpango-1.0-0.dll"), 0, 0);
        libgtk.setLoadHints(QLibrary::ImprovedSearchHeuristics);
        libgdk.setLoadHints(QLibrary::ImprovedSearchHeuristics);
        libgdkpb.setLoadHints(QLibrary::ImprovedSearchHeuristics);
        libpango.setLoadHints(QLibrary::ImprovedSearchHeuristics);

    #else
        #ifdef Q_OS_MAC
            QLibrary libgtk(QLS("gtk-quartz-2.0"), 0, 0);        
        #else
    ...
    void * ptr;
    #ifdef Q_OS_WIN
        ptr = libgtk. resolve(func);
        if (ptr != NULL) return ptr;
        ptr = libgdk. resolve(func);
        if (ptr != NULL) return ptr;
        ptr = libgdkpb. resolve(func);
        if (ptr != NULL) return ptr;
        ptr = libpango. resolve(func);
        if (ptr != NULL) return ptr;        
    #else
        ptr = libgtk. resolve(func);
        if (ptr != NULL) return ptr;
    ...
    fprintf (stderr,"QGtkStylePrivate::resolveGtk cannot find function %s\n",func);
    return NULL;
}
...
void QGtkStylePrivate::resolveGtk() const
{
    ...
    gtk_init = (Ptr_gtk_init)libgtk_resolve("gtk_init");
    g_gtk_init = gtk_init;
    gtk_window_new = (Ptr_gtk_window_new)libgtk_resolve("gtk_window_new");
    gtk_style_attach = (Ptr_gtk_style_attach)libgtk_resolve("gtk_style_attach");
    gtk_widget_destroy = (Ptr_gtk_widget_destroy)libgtk_resolve("gtk_widget_destroy");
    gtk_widget_realize = (Ptr_gtk_widget_realize)libgtk_resolve("gtk_widget_realize");

    gtk_file_chooser_set_current_folder = (Ptr_gtk_file_chooser_set_current_folder)libgtk_resolve("gtk_file_chooser_set_current_folder");
    gtk_file_filter_new = (Ptr_gtk_file_filter_new)libgtk_resolve("gtk_file_filter_new");
    gtk_file_filter_set_name = (Ptr_gtk_file_filter_set_name)libgtk_resolve("gtk_file_filter_set_name");
    gtk_file_filter_add_pattern = (Ptr_gtk_file_filter_add_pattern)libgtk_resolve("gtk_file_filter_add_pattern");
    gtk_file_chooser_add_filter = (Ptr_gtk_file_chooser_add_filter)libgtk_resolve("gtk_file_chooser_add_filter");
    gtk_file_chooser_set_filter = (Ptr_gtk_file_chooser_set_filter)libgtk_resolve("gtk_file_chooser_set_filter");
    gtk_file_chooser_get_filter = (Ptr_gtk_file_chooser_get_filter)libgtk_resolve("gtk_file_chooser_get_filter");
    gtk_file_chooser_dialog_new = (Ptr_gtk_file_chooser_dialog_new)libgtk_resolve("gtk_file_chooser_dialog_new");
    gtk_file_chooser_set_current_folder = (Ptr_gtk_file_chooser_set_current_folder)libgtk_resolve("gtk_file_chooser_set_current_folder");
    gtk_file_chooser_get_filename = (Ptr_gtk_file_chooser_get_filename)libgtk_resolve("gtk_file_chooser_get_filename");
    gtk_file_chooser_get_filenames = (Ptr_gtk_file_chooser_get_filenames)libgtk_resolve("gtk_file_chooser_get_filenames");
    gtk_file_chooser_set_current_name = (Ptr_gtk_file_chooser_set_current_name)libgtk_resolve("gtk_file_chooser_set_current_name");
    gtk_dialog_run = (Ptr_gtk_dialog_run)libgtk_resolve("gtk_dialog_run");
    gtk_file_chooser_set_filename = (Ptr_gtk_file_chooser_set_filename)libgtk_resolve("gtk_file_chooser_set_filename");

    gdk_pixbuf_get_pixels = (Ptr_gdk_pixbuf_get_pixels)libgtk_resolve("gdk_pixbuf_get_pixels");
    gdk_pixbuf_get_width = (Ptr_gdk_pixbuf_get_width)libgtk_resolve("gdk_pixbuf_get_width");
    gdk_pixbuf_get_height = (Ptr_gdk_pixbuf_get_height)libgtk_resolve("gdk_pixbuf_get_height");
    gdk_pixmap_new = (Ptr_gdk_pixmap_new)libgtk_resolve("gdk_pixmap_new");
    gdk_pixbuf_new = (Ptr_gdk_pixbuf_new)libgtk_resolve("gdk_pixbuf_new");
    gdk_pixbuf_get_from_drawable = (Ptr_gdk_pixbuf_get_from_drawable)libgtk_resolve("gdk_pixbuf_get_from_drawable");
    gdk_draw_rectangle = (Ptr_gdk_draw_rectangle)libgtk_resolve("gdk_draw_rectangle");
    gdk_pixbuf_unref = (Ptr_gdk_pixbuf_unref)libgtk_resolve("gdk_pixbuf_unref");
    gdk_drawable_unref = (Ptr_gdk_drawable_unref)libgtk_resolve("gdk_drawable_unref");
    gdk_drawable_get_depth = (Ptr_gdk_drawable_get_depth)libgtk_resolve("gdk_drawable_get_depth");
    gdk_color_free = (Ptr_gdk_color_free)libgtk_resolve("gdk_color_free");
    //gdk_x11_window_set_user_time = (Ptr_gdk_x11_window_set_user_time)libgtk_resolve("gdk_x11_window_set_user_time");
    //gdk_x11_drawable_get_xid = (Ptr_gdk_x11_drawable_get_xid)libgtk_resolve("gdk_x11_drawable_get_xid");
    //gdk_x11_drawable_get_xdisplay = (Ptr_gdk_x11_drawable_get_xdisplay)libgtk_resolve("gdk_x11_drawable_get_xdisplay");

    gtk_widget_set_default_direction = (Ptr_gtk_widget_set_default_direction)libgtk_resolve("gtk_widget_set_default_direction");
    gtk_widget_modify_fg = (Ptr_gtk_widget_modify_color)libgtk_resolve("gtk_widget_modify_fg");
    gtk_widget_modify_bg = (Ptr_gtk_widget_modify_color)libgtk_resolve("gtk_widget_modify_bg");
    gtk_arrow_new = (Ptr_gtk_arrow_new)libgtk_resolve("gtk_arrow_new");
    gtk_menu_item_new_with_label = (Ptr_gtk_menu_item_new_with_label)libgtk_resolve("gtk_menu_item_new_with_label");
    gtk_check_menu_item_new_with_label = (Ptr_gtk_check_menu_item_new_with_label)libgtk_resolve("gtk_check_menu_item_new_with_label");
    gtk_menu_bar_new = (Ptr_gtk_menu_bar_new)libgtk_resolve("gtk_menu_bar_new");
    gtk_menu_new = (Ptr_gtk_menu_new)libgtk_resolve("gtk_menu_new");
    gtk_toolbar_new = (Ptr_gtk_toolbar_new)libgtk_resolve("gtk_toolbar_new");
    gtk_separator_tool_item_new = (Ptr_gtk_separator_tool_item_new)libgtk_resolve("gtk_separator_tool_item_new");
    gtk_toolbar_insert = (Ptr_gtk_toolbar_insert)libgtk_resolve("gtk_toolbar_insert");
    gtk_button_new = (Ptr_gtk_button_new)libgtk_resolve("gtk_button_new");
    gtk_tool_button_new = (Ptr_gtk_tool_button_new)libgtk_resolve("gtk_tool_button_new");
    gtk_hbutton_box_new = (Ptr_gtk_hbutton_box_new)libgtk_resolve("gtk_hbutton_box_new");
    gtk_check_button_new = (Ptr_gtk_check_button_new)libgtk_resolve("gtk_check_button_new");
    gtk_radio_button_new = (Ptr_gtk_radio_button_new)libgtk_resolve("gtk_radio_button_new");
    gtk_notebook_new = (Ptr_gtk_notebook_new)libgtk_resolve("gtk_notebook_new");
    gtk_progress_bar_new = (Ptr_gtk_progress_bar_new)libgtk_resolve("gtk_progress_bar_new");
    gtk_spin_button_new = (Ptr_gtk_spin_button_new)libgtk_resolve("gtk_spin_button_new");
    gtk_hscale_new = (Ptr_gtk_hscale_new)libgtk_resolve("gtk_hscale_new");
    gtk_vscale_new = (Ptr_gtk_vscale_new)libgtk_resolve("gtk_vscale_new");
    gtk_hscrollbar_new = (Ptr_gtk_hscrollbar_new)libgtk_resolve("gtk_hscrollbar_new");
    gtk_vscrollbar_new = (Ptr_gtk_vscrollbar_new)libgtk_resolve("gtk_vscrollbar_new");
    gtk_scrolled_window_new = (Ptr_gtk_scrolled_window_new)libgtk_resolve("gtk_scrolled_window_new");
    gtk_menu_shell_append = (Ptr_gtk_menu_shell_append)libgtk_resolve("gtk_menu_shell_append");
    gtk_entry_new = (Ptr_gtk_entry_new)libgtk_resolve("gtk_entry_new");
    gtk_tree_view_new = (Ptr_gtk_tree_view_new)libgtk_resolve("gtk_tree_view_new");
    gtk_combo_box_new = (Ptr_gtk_combo_box_new)libgtk_resolve("gtk_combo_box_new");
    gtk_progress_configure = (Ptr_gtk_progress_configure)libgtk_resolve("gtk_progress_configure");
    gtk_range_get_adjustment = (Ptr_gtk_range_get_adjustment)libgtk_resolve("gtk_range_get_adjustment");
    gtk_range_set_adjustment = (Ptr_gtk_range_set_adjustment)libgtk_resolve("gtk_range_set_adjustment");
    gtk_range_set_inverted = (Ptr_gtk_range_set_inverted)libgtk_resolve("gtk_range_set_inverted");
    gtk_container_add = (Ptr_gtk_container_add)libgtk_resolve("gtk_container_add");
    gtk_icon_factory_lookup_default = (Ptr_gtk_icon_factory_lookup_default)libgtk_resolve("gtk_icon_factory_lookup_default");
    gtk_icon_theme_get_default = (Ptr_gtk_icon_theme_get_default)libgtk_resolve("gtk_icon_theme_get_default");
    gtk_widget_style_get = (Ptr_gtk_widget_style_get)libgtk_resolve("gtk_widget_style_get");
    gtk_icon_set_render_icon = (Ptr_gtk_icon_set_render_icon)libgtk_resolve("gtk_icon_set_render_icon");
    gtk_fixed_new = (Ptr_gtk_fixed_new)libgtk_resolve("gtk_fixed_new");
    gtk_tree_view_column_new = (Ptr_gtk_tree_view_column_new)libgtk_resolve("gtk_tree_view_column_new");
    gtk_tree_view_append_column= (Ptr_gtk_tree_view_append_column )libgtk_resolve("gtk_tree_view_append_column");
    gtk_tree_view_get_column = (Ptr_gtk_tree_view_get_column )libgtk_resolve("gtk_tree_view_get_column");
    gtk_paint_check = (Ptr_gtk_paint_check)libgtk_resolve("gtk_paint_check");
    gtk_paint_box = (Ptr_gtk_paint_box)libgtk_resolve("gtk_paint_box");
    gtk_paint_flat_box = (Ptr_gtk_paint_flat_box)libgtk_resolve("gtk_paint_flat_box");
    gtk_paint_check = (Ptr_gtk_paint_check)libgtk_resolve("gtk_paint_check");
    gtk_paint_box = (Ptr_gtk_paint_box)libgtk_resolve("gtk_paint_box");
    gtk_paint_resize_grip = (Ptr_gtk_paint_resize_grip)libgtk_resolve("gtk_paint_resize_grip");
    gtk_paint_focus = (Ptr_gtk_paint_focus)libgtk_resolve("gtk_paint_focus");
    gtk_paint_shadow = (Ptr_gtk_paint_shadow)libgtk_resolve("gtk_paint_shadow");
    gtk_paint_slider = (Ptr_gtk_paint_slider)libgtk_resolve("gtk_paint_slider");
    gtk_paint_expander = (Ptr_gtk_paint_expander)libgtk_resolve("gtk_paint_expander");
    gtk_paint_handle = (Ptr_gtk_paint_handle)libgtk_resolve("gtk_paint_handle");
    gtk_paint_option = (Ptr_gtk_paint_option)libgtk_resolve("gtk_paint_option");
    gtk_paint_arrow = (Ptr_gtk_paint_arrow)libgtk_resolve("gtk_paint_arrow");
    gtk_paint_box_gap = (Ptr_gtk_paint_box_gap)libgtk_resolve("gtk_paint_box_gap");
    gtk_paint_extension = (Ptr_gtk_paint_extension)libgtk_resolve("gtk_paint_extension");
    gtk_paint_hline = (Ptr_gtk_paint_hline)libgtk_resolve("gtk_paint_hline");
    gtk_paint_vline = (Ptr_gtk_paint_vline)libgtk_resolve("gtk_paint_vline");
    gtk_adjustment_configure = (Ptr_gtk_adjustment_configure)libgtk_resolve("gtk_adjustment_configure");
    gtk_adjustment_new = (Ptr_gtk_adjustment_new)libgtk_resolve("gtk_adjustment_new");
    gtk_menu_item_set_submenu = (Ptr_gtk_menu_item_set_submenu)libgtk_resolve("gtk_menu_item_set_submenu");
    gtk_settings_get_default = (Ptr_gtk_settings_get_default)libgtk_resolve("gtk_settings_get_default");
    gtk_separator_menu_item_new = (Ptr_gtk_separator_menu_item_new)libgtk_resolve("gtk_separator_menu_item_new");
    gtk_frame_new = (Ptr_gtk_frame_new)libgtk_resolve("gtk_frame_new");
    gtk_expander_new = (Ptr_gtk_expander_new)libgtk_resolve("gtk_expander_new");
    gtk_statusbar_new = (Ptr_gtk_statusbar_new)libgtk_resolve("gtk_statusbar_new");
    gtk_combo_box_entry_new = (Ptr_gtk_combo_box_entry_new)libgtk_resolve("gtk_combo_box_entry_new");
    gtk_container_forall = (Ptr_gtk_container_forall)libgtk_resolve("gtk_container_forall");
    gtk_widget_size_allocate =(Ptr_gtk_widget_size_allocate)libgtk_resolve("gtk_widget_size_allocate");
    gtk_widget_size_request =(Ptr_gtk_widget_size_request)libgtk_resolve("gtk_widget_size_request");
    gtk_widget_set_direction =(Ptr_gtk_widget_set_direction)libgtk_resolve("gtk_widget_set_direction");
    gtk_widget_path =(Ptr_gtk_widget_path)libgtk_resolve("gtk_widget_path");
    gtk_container_get_type =(Ptr_gtk_container_get_type)libgtk_resolve("gtk_container_get_type");
    gtk_window_get_type =(Ptr_gtk_window_get_type)libgtk_resolve("gtk_window_get_type");
    gtk_widget_get_type =(Ptr_gtk_widget_get_type)libgtk_resolve("gtk_widget_get_type");

    gtk_rc_get_style_by_paths =(Ptr_gtk_rc_get_style_by_paths)libgtk_resolve("gtk_rc_get_style_by_paths");
    gtk_rc_add_default_file=(Ptr_gtk_rc_add_default_file)libgtk_resolve("gtk_rc_add_default_file");
    gtk_rc_reparse_all_for_settings=(Ptr_gtk_rc_reparse_all_for_settings)libgtk_resolve("gtk_rc_reparse_all_for_settings");
    gtk_rc_reparse_all=(Ptr_gtk_rc_reparse_all)libgtk_resolve("gtk_rc_reparse_all");
    gtk_rc_get_theme_dir=(Ptr_gtk_rc_get_theme_dir)libgtk_resolve("gtk_rc_get_theme_dir");

    gtk_check_version =(Ptr_gtk_check_version)libgtk_resolve("gtk_check_version");
    gtk_border_free =(Ptr_gtk_border_free)libgtk_resolve("gtk_border_free");
    pango_font_description_get_size = (Ptr_pango_font_description_get_size)libgtk_resolve("pango_font_description_get_size");
    pango_font_description_get_weight = (Ptr_pango_font_description_get_weight)libgtk_resolve("pango_font_description_get_weight");
    pango_font_description_get_family = (Ptr_pango_font_description_get_family)libgtk_resolve("pango_font_description_get_family");
    pango_font_description_get_style = (Ptr_pango_font_description_get_style)libgtk_resolve("pango_font_description_get_style");
#ifndef Q_OS_WIN
...
void QGtkStylePrivate::initGtkWidgets() const
{
    ...
    if (g_gtk_init) {
        ...
        QHashableLatin1Literal widgetPath = QHashableLatin1Literal::fromData(_strdup("GtkWindow"));
        ...
        QString themePath = QString::fromLocal8Bit(gtk_rc_get_theme_dir());
        //printf ("THEME PATH %s \n",qPrintable(themePath));
        qApp->setProperty("QTGTK_RC_THEMEPATH",themePath);
        QDir dir(themePath);
        QStringList themeList = dir.entryList(QStringList(),QDir::AllDirs | QDir::NoDotAndDotDot);
        qApp->setProperty("QTGTK_RC_THEMES",themeList);

        QString rcPath = qApp->property("QTGTK_RC_FILE").toString();
        QString rcFile = QString::fromLocal8Bit(qgetenv("GTK2_RC_FILES"));
        if (!rcFile.isEmpty()) {
            QDir dir(rcFile);
            dir.cdUp();dir.cdUp();
            QTemporaryFile tempFile;
            if (tempFile.open()) {
                QTextStream(&tempFile) << "gtk-theme-name = \"" << dir.dirName() << "\"\n\n"
                                       << "style \"user-font\"\n{\nfont_name=\"" << qApp->font().family()
                                                                                 << qApp->font().pointSize() << "\"\n}\n"
                                       << "widget_class \"*\" style \"user-font\"";
                //tempFile.write(qPrintable(QString("gtk-theme-name = \"%1\"\n\n").arg(dir.dirName())));
                //tempFile.write(qPrintable(QString("style \"user-font\"\n{\nfont_name=\"%1 %2\"\n}\n").arg(qApp->font().family()).arg(qApp->font().pointSize())));
                //tempFile.write(qPrintable(QString("widget_class \"*\" style \"user-font\"")));
                tempFile.close();
                rcPath = tempFile.fileName();
            }
        }
        //printf ("THEME RC %s\n",qPrintable(rcPath));
        if (!rcPath.isEmpty()) {
            ...
            gtk_rc_add_default_file(qPrintable(rcPath));
